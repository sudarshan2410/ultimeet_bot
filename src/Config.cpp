...
// Added Sudarshan command-line arguments for SDK
Config::Config() :
...
int Config::read(int ac, char **av) {
    ...
    std::cout << "Client ID: " << m_clientId << std::endl;
    std::cout << "Client Secret: " << m_clientSecret << std::endl;
    std::cout << "Meeting ID: " << m_meetingId << std::endl;
    std::cout << "Join URL: " << m_joinUrl << std::endl;
    std::cout << "Audio File: " << m_audioFile << std::endl;
    std::cout << "Video File: " << m_videoFile << std::endl;
    std::cout << "Use Raw Audio: " << useRawAudio() << std::endl;
    std::cout << "Use Raw Video: " << useRawVideo() << std::endl;
